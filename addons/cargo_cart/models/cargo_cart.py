...
class CargoCart(models.Model):
    ...
    # Computed totals
    subtotal = fields.Float('Subtotal', compute='_compute_totals', digits=(10, 2))
    total    = fields.Float('Total',    compute='_compute_totals', digits=(10, 2))
...
class CargoCartLine(models.Model):
    ...
    product_id = fields.Many2one('cargo.product', 'Product', ondelete='cascade', required=True)
